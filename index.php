...
<body   >
    ...
    <div class="container "  >
        <div class=" card " >
            ...
            <button onclick="window.location.href='index1.php'" type="button"  class="btn btn-secondary btn-lg container" style="background-color: #00C1FE; border: none;"> SIGN IN</button>
            </div>
